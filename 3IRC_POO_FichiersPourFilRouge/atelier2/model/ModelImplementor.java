...
public class ModelImplementor {
	...
	public boolean isPromotable(Coord targetCoord) {
		...
		PieceModel piece = this.findPiece(targetCoord);
		if(piece != null && piece instanceof PawnModel) {
			promotable = ((PawnModel)piece).isPromotable();
		}
		return promotable;
	}
	...
	public void promotePiece(Coord targetCoord) {
		...
		PieceModel piece = this.findPiece(targetCoord);
			if(piece != null && piece instanceof PawnModel) {
				QueenModel queen = new QueenModel(targetCoord, piece.getPieceColor());
